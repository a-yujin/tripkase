	...
	<div class="memberDiv">
		<h2 align="center">회원 상세 조회</h2>
				<table id="memberTable" class="table table-hover" border="1">
					...
					<tr align="center">
						<td colspan="2">
						<button class="btn btn-dark" type="button" onclick="location.href='/admin/modifyMemberView.tripkase?memberId=${member.memberId}&memberName=${member.memberName }'">수정</button>
						<button class="btn btn-dark" type="button" onclick="location.href='/admin/deleteMember.tripkase?memberId=${member.memberId}'">삭제</button>
					</td>
				</table>
	</div>
</div>
