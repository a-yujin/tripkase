...
public class AttrImgDomain {
	...
	public String toString() {
		return "AttrImgDomain [attrNo=" + attrNo + ", attrLocation=" + attrLocation + ", attrName=" + attrName
				...
				+ attrShortInfo + ", attrStatus=" + attrStatus + ", attrImgNo=" + attrImgNo + ", attrFileName="
